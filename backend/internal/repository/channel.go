...
type ChannelRepository interface {
	...
	UpdateManagedContextFields(ctx context.Context, upstreamID uint, capsJSON string, checkedAt time.Time, errorCode string) error
	UpdateManagedContextRolloutState(ctx context.Context, upstreamID uint, state string) error
	UpdateManagedContextProtocolVersion(ctx context.Context, upstreamID uint, protocolVersion string) error
	UpdateManagedContextBuild(ctx context.Context, upstreamID uint, commit, time, version string) error
}
