...
type BillingRepository interface {
	...
	ListUsageLeaderboard(ctx context.Context, filter UsageLeaderboardFilter, offset int, limit int) ([]domainbilling.UsageLeaderboardEntry, int64, error)
	ListUsageTrend(ctx context.Context, filter UsageTrendFilter) ([]domainbilling.UsageTrendBucket, error)
}
