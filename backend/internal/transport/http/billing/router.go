...
func (m *Module) RegisterAdminRoutes(adminGroup *gin.RouterGroup) {
	...
	adminGroup.GET("/billing/usage-logs", m.Handler.ListUsageLogs)
	adminGroup.GET("/billing/usage-leaderboard", m.Handler.ListUsageLeaderboard)
	adminGroup.GET("/billing/usage-leaderboard/trend", m.Handler.ListUsageTrend)
}
