...
type yamlConfig struct {
	...
	WeChatBot struct {
		...
		HubUsername        string `yaml:"hub_username"`
		...
		ReconnectHours     int    `yaml:"reconnect_before_expiry_hours"`
		DefaultModel       string `yaml:"default_model"`
		PerContactSessions *bool  `yaml:"per_contact_sessions"`
	} `yaml:"wechat_bot"`
...
type Config struct {
	...
	// 微信机器人配置
	WeChatBotEnabled             bool
	WeChatBotHubURL              string
	WeChatBotHubUsername         string
	WeChatBotHubPassword         string
	WeChatBotAPITimeoutSeconds   int
	WeChatBotPollTimeoutSeconds  int
	WeChatBotReconnectHours      int
	WeChatBotDefaultModel        string
	WeChatBotPerContactSessions  bool
...
func Load() Config {
	...
	return Config{
		// 静态基础设施
		AppName:                      envOr("APP_NAME", yc.App.Name, "WithYou"),
		...
		WeChatBotEnabled:             envOrBoolPtr("WECHAT_BOT_ENABLED", yc.WeChatBot.Enabled, false),
		WeChatBotHubURL:              envOr("WECHAT_BOT_HUB_URL", yc.WeChatBot.HubURL, "http://openilink-hub:9800"),
		WeChatBotHubUsername:         envOr("WECHAT_BOT_HUB_USERNAME", yc.WeChatBot.HubUsername, "deeix-bot"),
		WeChatBotHubPassword:         envOr("WECHAT_BOT_HUB_PASSWORD", yc.WeChatBot.HubPassword, "deeix-bot-2026"),
		WeChatBotAPITimeoutSeconds:   envOrInt("WECHAT_BOT_API_TIMEOUT_SECONDS", yc.WeChatBot.APITimeoutSeconds, 30),
		WeChatBotPollTimeoutSeconds:  envOrInt("WECHAT_BOT_POLL_TIMEOUT_SECONDS", yc.WeChatBot.PollTimeoutSeconds, 35),
		WeChatBotReconnectHours:      envOrInt("WECHAT_BOT_RECONNECT_HOURS", yc.WeChatBot.ReconnectHours, 22),
		WeChatBotDefaultModel:        envOr("WECHAT_BOT_DEFAULT_MODEL", yc.WeChatBot.DefaultModel, "withyou-学员版"),
		WeChatBotPerContactSessions:  envOrBoolPtr("WECHAT_BOT_PER_CONTACT_SESSIONS", yc.WeChatBot.PerContactSessions, false),
