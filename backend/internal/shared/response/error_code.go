...
const (
	...
	CodeWeChatBotAlreadyBound    = "wechatbot.already_bound"
)
...
var exactErrorSpecs = map[string]errorSpec{
	...
	"already_bound":                                              {Code: CodeWeChatBotAlreadyBound, Message: "bot already bound"},
...
var fallbackMessages = map[string]string{
	...
	"wechatbot.already_bound":                           "bot already bound",
