	...
	rules := map[string]outboundCallSiteRule{
		...
		"&http.Client{": {
			...
			files: allowFiles(
				...
				"internal/application/llmpool/service.go",
				"internal/application/managedcontext/collector.go",
				"internal/application/managedcontext/realtime.go",
				"internal/application/managedcontext/service.go",
				"internal/application/wechatbot/service.go",
