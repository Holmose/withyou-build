...
func (r *billingRepositoryStub) ListUsageLeaderboard(context.Context, repository.UsageLeaderboardFilter, int, int) ([]domainbilling.UsageLeaderboardEntry, int64, error) {
	panic("not used")
}
func (r *billingRepositoryStub) ListUsageTrend(context.Context, repository.UsageTrendFilter) ([]domainbilling.UsageTrendBucket, error) {
	panic("not used")
}
...
func TestRecordUsageWithReservationUsesBillingAtForPeriod(t *testing.T) {
	...
	if got, want := repo.periodStartAt.Format("2006-01-02"), "2026-06-29"; got != want {
