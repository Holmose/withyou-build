...
func (r *modelUpdateRepo) UpdateManagedContextBuild(context.Context, uint, string, string, string) error {
	return nil
}

func (r *modelUpdateRepo) UpdateManagedContextFields(context.Context, uint, string, time.Time, string) error {
	return nil
}

func (r *modelUpdateRepo) UpdateManagedContextRolloutState(context.Context, uint, string) error {
	return nil
}

func (r *modelUpdateRepo) UpdateManagedContextProtocolVersion(context.Context, uint, string) error {
	return nil
}
